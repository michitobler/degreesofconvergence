...
## Input files
- [FPKM_AllGenes.csv](https://github.com/michitobler/degreesofconvergence/blob/main/FPKM_AllGenes.csv): Gene expression levels in FPKM (Fragments Per Kilobase of transcript per Million mapped reads) for 31,804 genes in 118 samples analyzed for this study
